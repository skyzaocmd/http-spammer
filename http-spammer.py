...
print("Not made by me i just changed some nigga things")
...
def main():
    ...
    try:
        ...
        brute.stop()
        print(stage(f"Attack stopped. {fluo2}{ip}{cport}{white} was spammed with {fluo}{round(brute.total, 1)} {white}Gb.", '.'))
    print('\n')
    sleep(1)
